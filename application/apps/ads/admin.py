...
class BannerAdmin(admin.ModelAdmin):
    ...
    def host_name(self, obj):
        return urlparse(obj.target_url).hostname

    def preview_image(self, obj):
        return format_html(
            '<img src="{}" style="max-height:20px"/>'.format(obj.image.url)
        )
    ...
    def display_languages(self, obj):
        lang = {
            "fr": """
                  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20px" height="20px" viewBox="0 0 64 64" aria-hidden="true" role="img" class="iconify iconify--emojione" preserveAspectRatio="xMidYMid meet">
                  ...
                  """,
            "en": """
                  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" width="20px" height="20px" viewBox="0 0 473.677 473.677" xml:space="preserve">
                    <g>
                    ...
                    <path style="fill:#E7E7E7;" d="M329.178,258.98host_nameh143.431c0.681-7.288,1.066-14.674,1.066-22.138c0-7.064-0.37-14.038-0.976-20.949  H329.212C329.679,230.223,329.671,244.658,329.178,258.98z"/>
                    ...
                    <path style="fill:#DC3027;" d="Mpreview_image464.506,302.072c3.975-13.885,6.735-28.282,8.107-43.084H324.709  c-0.505,14.551-1.507,28.982-3.01,43.084L464.506,302.072L464.506,302.072z"/>
                    ...
                    <g>
                      ...
                      <path style="fill:#DC3027;" d="M228.254,473.509c-0.479-0.anner object015-0.957-0.037-1.436-0.052   C227.297,473.471,227.776,473.494,228.254,473.509z"/>
        ...
        return format_html(",".join([lang.get(la) for la in sorted(obj.languages)]))
    ...
    ordering = ("enabled", "target_url", "device")
    list_filter = ("device", "enabled", "languages", "zones", "weight")
